...
- **2025-10-21**: [MiDashengLM-7b-1021](https://huggingface.co/mispeech/midashenglm-7b-1021-fp32) supports the instruction-following mode, enabling the model to follow human instructions in the audio. It plays a key role in building an audio question-answering assistant for efficient and natural interactions. The examples are in the [Gradio](https://modelscope.cn/studios/midasheng/MiDashengLM-7B).
